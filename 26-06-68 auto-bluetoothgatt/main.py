...
class BluetoothGATTApp(MDApp):
    ...
    def build(self):
        ...
        self.target_data_set = [
            {"uuid": "A7E39D7510F2FE254DAE4230DBC6C3A4", "major": 888},
            {"uuid": "A7E39D7510F2FE254DAE4230DBC6C3A4", "major": 111},
    ...
    def send_data(self):
                ...
                for device in self.scanned_point: # กำหนดเป็น list เปล่าแทน None
    ...
    def display_scan_results(self):
                ...
                for uuid, major, rssi in self.scan_results:
                    ...
                    if uuid == None:
                        ...
                        if ((uuid == "A7E39D7510F2FE254DAE4230DBC6C3A4") & (major == 111)):
                            name = "A1(VER)"
                            anchor_id = "A1_V"
                            scanned_info += f"{name}, RSSI: {rssi} dBm\n"
                            A1_V = rssi
                            
                        elif ((uuid == "A7E39D7510F2FE254DAE4230DBC6C3A4") & (major == 888)):
                            name = "A1(HOR)"
                            anchor_id = "A1_H"
                            scanned_info += f"{name}, RSSI: {rssi} dBm\n"
                            A1_H = rssi
