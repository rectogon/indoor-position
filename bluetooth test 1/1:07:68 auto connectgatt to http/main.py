...
class BluetoothGATTApp(MDApp):
    ...
    def build(self):
        ...
        self.target_data_set = [
            ...
            {"uuid": "18DC32EBBD664931152AD431D364E262", "major": 0},
    ...
    def display_scan_results(self):
        ...
        for uuid, major, rssi in self.scan_results:
            ...
            elif uuid == "18DC32EBBD664931152AD431D364E262" and major == 0:
                name = "A3(VEA)"
                anchor_id = "A3_V"
                A3_V = rssi

            elif uuid == "18DC32EBBD664931152AD431D364E262" and major == 111:
                name = "A3(VEA)"
                anchor_id = "A3_H"
                A3_H = rssi
...
###############################################################
    ...
    def check_discovered_device(self, dt):
        try:
            ...
            if is_target_device:
                ...
                # เช็คว่าตอนนี้เชื่อมต่อกับ device นี้อยู่หรือยัง
    ...
    def display_target_device_info(self, name, uuid, rssi, major, minor):
        ...
        try:
            ...
            if len(self.found_data) >= 4:
                self.root.ids.label.text = "✅ Connceted 4 devices"
    ...
    def get_target_name(self, uuid, major):
        ...
        try:
            if uuid.upper() == "818B88DD1659CE50979E8B0C9257F640":
